...
!![Pasted_image_20260823143052.png](assets/Pasted_image_20260823143052.png)Перевод:  "Джейк, пожалуйста, смени пароль. Он слишком слабый, и Холт будет в ярости, если кто-нибудь взломает систему 99-го участка. "
На данный момент,это мало что дает,перейдем к 80 порту и зайдем на сайт.
!![Pasted_image_20260823143239.png](assets/Pasted_image_20260823143239.png)Перевод:  "В этом примере создается фоновое изображение на всю страницу. Попробуйте изменить размер окна браузера, чтобы увидеть, как оно всегда заполняет весь экран (при прокрутке в самое начало) и корректно масштабируется на экранах любого размера. "
